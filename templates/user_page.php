...
<head>
    ...
    error_reporting( error_reporting() & ~E_NOTICE );
      ...
      $sql ="SELECT * from adminpage WHERE ID = '".$objResult['ID']."' ";
...
<br>      
    ...
    <table class border="1" align="CENTER" cellpadding=15 id = "info" > 
        <tbody align="CENTER" >
          <tr cellpadding=15>
            <!-- <th rowspan="2">ID</th> -->
            <th rowspan="2">ID</th> <th rowspan="2">ชื่อ-สกุล</th><th rowspan="2">สำนักวิชา</th>  <th rowspan="2">ยื่นขอตำแหน่ง</th> <th rowspan="2">ในสาขาวิชา</th> 
            <th rowspan="2">รหัสสาขาวิชา</th> <th rowspan="2">อนุสาขาวิชา</th> <th rowspan="2">รหัสอนุสาขาวิชา</th> 
            <th rowspan>Progress</th>
          ...
          ?> 
                <tr>
                  ...
                  <td><?php echo $rows['Nameschool']; ?></td>
                  ...
                  <td>
                    <a href="progress.php?ID=<?php echo $rows["ID"]; ?>">
                    <img src="../pic/draw.png" width="28" height="28">
                    </a>
                  </td>
